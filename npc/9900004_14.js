...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
			...
			text += "\t\t\t  #e您当前点券为：#b"+cm.getPlayer().getCSPoints(1)+"#k!#n\r\n"
            text += "#L1##e#d100点券兑换1个交易币#l\r\n\r\n"//3
            text += "#L2##d500点券兑换5个交易币#l\r\n\r\n"//3
            text += "#L3##d1000点券兑换10个交易币#l\r\n\r\n"//3
            text += "#L4##d5000点券兑换50个交易币#l\r\n\r\n"//3
            text += "#L5##d10000点券兑换100个交易币#l\r\n\r\n"//3
            text += "#L6##r1个交易币兑换100点券#l\r\n\r\n"//3
            text += "#L7##r5个交易币兑换500点券#l\r\n\r\n"//3
            text += "#L8##r10个交易币兑换1000点券#l\r\n\r\n"//3
            text += "#L9##r50个交易币兑换5000点券#l\r\n\r\n"//3
            text += "#L10##r100个交易币兑换10000点券#l\r\n\r\n"//3
            cm.sendSimple(text);
        } else if (selection == 1) {
