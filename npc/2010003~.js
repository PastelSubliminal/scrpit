...
function action(mode, type, selection) {
	...
	var options = new Array("做一双/升级战士手套","做一双/升级弓箭手手套","做一双/升级魔法师手套","做一双/升级飞侠手套");
	...
	if (selectedType == 0){ //warrior glove
	    ...
	    var selStr = "需要什么吗？？#b";
	    var gloves = new Array ("#t1082098##k - 魔法师 等级. 70#b","#t1082099##k - 魔法师 等级. 70#b","#t1082100##k - 魔法师 等级. 70#b",
		"#t1082121##k - 魔法师 等级. 80#b","#t1082122##k - 魔法师 等级. 80#b","#t1082123##k - 魔法师 等级. 80#b");
	    for (var i = 0; i < gloves.length; i++){
		selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
	    }
	    cm.sendSimple(selStr);
