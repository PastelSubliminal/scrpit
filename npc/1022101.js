...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            text += "#L5##d" + 蓝色箭头 + "毒雾组队副本#l#L6##d" + 蓝色箭头 + "海盗组队副本#l\r\n\r\n"//3
            ...
            if (cm.getLevel() < 50 && cm.getBossLog('PlayQuest1') < 5) {  
            cm.sendOk("现在还不能挑战大王蜈蚣，你还没有到达50级，或今天已挑战5次");
                cm.dispose();
              }else{
			cm.warp(701010322);  
				cm.dispose();
