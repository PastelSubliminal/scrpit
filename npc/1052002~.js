...
function action(mode, type, selection) {
	...
	if (selectedType == 0){ //glove refine
	    ...
	    var gloves = new Array ("工作手套#k - 需要等级 Lv. 10#b","褐短指手套#k - 需要等级 Lv. 15#b","蓝短指手套#k - 需要等级 Lv. 15#b","黑短指手套#k - 需要等级 Lv. 15#b","青铜飞侠手套#k - 需要等级 Lv. 20#b","青铜精神手套#k - 需要等级 Lv. 25#b","钢铁暴风手套#k - 需要等级 Lv. 30#b",
		"钢铁追击手套#k - 需要等级 Lv. 35#b","红飞侠手套#k - 需要等级 Lv. 40#b","青月手套#k - 需要等级 Lv. 50#b","青铜柔丝手套#k - 需要等级 Lv. 60#b");
	    ...
	    var gloves = new Array ("锂矿飞侠手套#k - 需要等级 Lv. 20#b","黑色飞侠手套#k - 需要等级 Lv. 20#b","锂矿精神手套#k - 需要等级 Lv. 25#b",
		"黑精神手套#k - 需要等级 Lv. 25#b","银暴风手套#k - 需要等级 Lv. 30#b","黄金暴风手套#k - 需要等级 Lv. 30#b","紫矿追击手套#k - 需要等级 Lv. 35#b","黄金追击手套#k - 需要等级 Lv. 35#b","黄金飞侠手套#k - 需要等级 Lv. 40#b",
		"黑飞侠手套#k - 需要等级 Lv. 40#b","赤月手套#k - 需要等级 Lv. 50#b","黄月手套#k - 需要等级 Lv. 50#b","钢铁柔丝手套#k - 需要等级 Lv. 60#b","黄金柔丝手套#k - 需要等级 Lv. 60#b");
	    for (var i = 0; i < gloves.length; i++){
		selStr += "\r\n#L" + i + "# " + gloves[i] + "#l";
	    }
	    equip = true;
