...
Array(702000000,3000,300,'中国'),
Array(600000000,3000,300,'欧美'),
Array(540000000,3000,300,'新加坡'),
Array(800000000,3000,300,'日本'),
Array(701000000,3000,300,'中国'),
// Array(702100000,3000,300), //大雄宝殿
Array(550000000,3000,300,'马来西亚')
);//旅游地图部分
var selectedMap = -1;
var cost = 0;
...
var selStr = "现在就可以去往 #b泰国的水上市场，中国的少林寺，日本古代神社#k游览一番。在各旅游地我都会为大家提供满意热诚的服务。那么请准备好，新手可以9折优惠。#b";
				if (cm.getJob() == 0) {
					for (var i = 0; i < maps.length; i++) {
						selStr += "\r\n#L" + i + "##m" + maps[i][0] + "# ("+maps[i][3]+")#l";
					}
				}else{
					for (var i = 0; i < maps.length; i++) {
						selStr += "\r\n#L" + i + "##m" + maps[i][0] + "# ("+maps[i][3]+")#l";
	...
	} else if (cm.getChar().getMapId() == 500000000 || cm.getChar().getMapId() == 702000000 || cm.getChar().getMapId() == 800000000 || cm.getChar().getMapId() == 600000000 || cm.getChar().getMapId() == 540000000 || cm.getChar().getMapId() == 550000000 || cm.getChar().getMapId() == 551000000 || cm.getChar().getMapId() == 541000000 || cm.getChar().getMapId() == 220000000 || cm.getChar().getMapId() == 240000000 || cm.getChar().getMapId() == 701000000) {
		if (status == 0) {
