...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (status == 0) {
         ...
         } else if (selection == 2) {//树妖王
            if (cm.getLevel() < 20 ) {  
            cm.sendOk("本地图限制等级20级。您的能力没有资格挑战树妖王副本");
                cm.dispose();
              }else{
			cm.warp(101030404);  
				cm.dispose();
        ...
        } else if (selection == 4) {//巨居蟹
            if (cm.getLevel() < 30 ) {  
            cm.sendOk("本地图限制等级30级。您的能力没有资格挑战巨居蟹副本");
                cm.dispose();
              }else{
			cm.warp(110040000);  
				cm.dispose();
        ...
        } else if (selection == 8) {//多尔
            if (cm.getLevel() < 50 ) {  
            cm.sendOk("本地图限制等级50级。您的能力没有资格挑战多尔副本");
                cm.dispose();
              }else{
			cm.warp(107000300);  
				cm.dispose();
         ...
         } else if (selection == 13) {//格瑞芬多
            if (cm.getLevel() < 70 ) {  
            cm.sendOk("本地图限制等级70级。您的能力没有资格挑战格瑞芬多副本");
                cm.dispose();
              }else{
			cm.warp(240020101);  
				cm.dispose();
            ...
            if (cm.getLevel() < 30) {  
                cm.sendOk("本地图限制等级30级。您的能力没有资格挑战大王蜈蚣");
                cm.dispose();
            }
