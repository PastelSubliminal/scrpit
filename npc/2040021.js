...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        ...
        var options = new Array("什么是催化剂?", "做一双战士鞋子", "做一双弓箭手鞋子", "做一双魔法师鞋子", "做一双飞侠鞋子",
                "做一双战士鞋子使用催化剂", "做一双弓箭手鞋子使用催化剂", "做一双魔法师鞋子使用催化剂", "做一双飞侠鞋子使用催化剂");
        ...
        if (selectedType == 1) { //warrior shoe
            ...
            selStr = "很好，那么你想做哪一个？？#b";
            shoes = new Array("#t1072075##k - 魔法师 等级. 30#b", "#t1072076##k - 魔法师 等级. 30#b", "#t1072077##k - 魔法师 等级. 30#b", "#t1072078##k - 魔法师 等级. 30#b",
