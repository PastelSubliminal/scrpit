		...
		if (status == 0) {
		  ...
		  cm.sendOk("\t\t\t#e#b       飞天猪的愿望#n#d\r\n====================================================#k\r\n原来是法海大师的朋友，幸会幸会，大师身体可好？#k#d\r\n====================================================#k\r\n唉，说来话长，你知道吗，我从小就有一个愿望，就是能在天空中自由的飞翔，可是我老了，再也飞不动了。。。#d\r\n====================================================#k\r\n我想在天空中自由的飞翔，#r俯瞰神州大地#k，你能帮我实现这个愿望吗?#k#d\r\n====================================================#k\r\n如果能在#r东方神州的上空#k，哪怕只有一分钟，这辈子都值了！#d\r\n");
	          cm.dispose();
                ...
                cm.gainItem(1302192,300,300,300,300,0,0,90,0,0,0,0,0,0,0);
                ...
                cm.gainItem(1312098,300,300,300,300,0,0,90,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1322138,300,300,300,300,0,0,90,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1332168,300,300,300,300,0,0,87,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1372117,300,300,300,300,0,0,58,95,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(300,300,300,300,0,0,94,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1452147,300,300,300,300,0,0,87,0,0,0,0,0,0,3);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1462136,300,300,300,300,0,0,90,0,0,0,0,0,0,3);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1472159,300,300,300,300,0,0,39,0,4,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1482120,300,300,300,300,0,0,67,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1492119,300,300,300,300,0,0,67,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1402129,300,300,300,300,0,0,92,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1412087,300,300,300,300,0,0,94,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1422089,300,300,300,300,0,0,94,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
                ...
                cm.gainItem(1442154,300,300,300,300,0,0,85,0,0,0,0,0,0,0);
                cm.gainItem(4000313,-500);
              ...
              if (cm.haveItem(4000313,500)){
              cm.sendOk("#r#e恭喜您获得全属性300的传说冒险岛长杖.");
              cm.gainItem(1382142,300,300,300,300,0,0,60,93,0,0,0,0,0,0);
              cm.gainItem(4000313,-500);
              cm.喇叭(3,"厉害了word哥！！恭喜您获得了全属性300的传说冒险岛长杖！！");
              cm.dispose();		
              }else{ 
              cm.sendOk("#b您没有足够的黄金枫叶进行购买,请努力收集吧.");
              cm.dispose();	 
