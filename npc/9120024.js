...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "哈哈，我就是本服的觉醒商人新八，我有猥琐的觉醒方法可以帮助你把#v1122000##r★黑龙项环★#k完成一次#b神级觉醒（全属性80，攻击力50，魔力80）#k\r\n需要以下物品：（已经完成过神级觉醒的装备无效！）\r\n#v1122000# * 1个\r\n#v4000030##d#z4000030# * 100个\r\n#v4000014##d#z4000014# * 200个\r\n#v4021004##d#z4021004# * 30个\r\n#v4000313##d#z4000313# * 300张\r\n#v4032226##d#z4032226# * 300只\r\n#v2140002##d金币 * 2000W\r\n\r\n"
	text += "\r\n#L1##b我收集了以上物品。确定开始觉醒装备";
	text += "     \r\n"
        cm.sendSimple(text);
        } else if (selection == 1) {
            if(cm.haveItem(4000313,300) && cm.haveItem(4000030,100) && cm.haveItem(4000014,200) && cm.haveItem(4021004,30)  && cm.haveItem(4032226,300) && cm.haveItem(1122000,1) && cm.canHold(1122000,1)){
				...
				cm.gainItem(1122000, -1);
                    cm.gainItem(1122000,50,50,50,50,0,0,50,80,0,0,0,0,0,0);
