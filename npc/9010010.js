...
if (selection == 0) {
	if (cm.getLevel()>= 10 && cm.getBossLog('dailycheck0') < 1) {
	cm.dispose();
	...
	if (cm.getLevel()>= 30 && cm.getBossLog('dailycheck1') < 1) {
cm.dispose();
	...
	if (cm.getLevel()>= 70 && cm.getBossLog('dailycheck2') < 1) {
cm.dispose();
	...
	if (cm.getLevel()>= 120 && cm.getBossLog('dailycheck3') < 1) {
cm.dispose();
