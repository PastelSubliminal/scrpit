...
var needsj = 18000;//升级次数需要点券的数量[全部都是这个]
var slot;
var item;
var qty;
var display;
...
cm.sendOk("#b升级砸卷次数需要#r"+needsj+"#b个,你的点券不足!");
cm.dispose(); 
}
...
cm.sendOk("#b升级砸卷次数需要#r"+needsj+"#b个点券,你的点券不足!");
cm.dispose(); 
}else if (cm.getInventory(1).getItem(1).getUpgradeSlots() >=1) {
