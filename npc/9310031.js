...
var status = 0;
var adventureAndAran = [112, 122, 132, 212, 222, 232, 312, 322, 412, 422, 512, 522, 2112];
var cyguns = [1111, 1211, 1311, 1411, 1511];
...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
		if (status == 0) {
			cm.sendYesNo("我是#r技能全满#k商人，冒险家4转、战神4转、骑士团3转之后可使用。您确定需要花费1亿金币享受这项服务？");
		} else if (status == 1 /*|| cm.getLevel() >= 120 || adventureAndAran.indexOf(cm.getJob()) !== -1*/) {
			...
			// Start of Cygnus skill
			// Soul master 1st skill
			cm.teachSkill(11000000,10,10)
			cm.teachSkill(11000001,10,10)
			cm.teachSkill(11000002,20,20)
			cm.teachSkill(11000003,20,20)
			cm.teachSkill(11000004,20,20)
			// Soul master 2nd skill
			...
			cm.teachSkill(11100000,10,10)
			// Soul master 3rd skill
			cm.teachSkill(11110000,20,20)
			cm.teachSkill(11110001,20,20)
			cm.teachSkill(11110002,20,20)
			cm.teachSkill(11110003,20,20)
			cm.teachSkill(11110004,30,20)
			cm.teachSkill(11110005,20,20)
			cm.teachSkill(11110006,30,20)
			cm.teachSkill(11110007,20,20)
			// Wind breaker 1st skill
			cm.teachSkill(13000000,20,20)
			cm.teachSkill(13000001,8,8)
			cm.teachSkill(13000002,10,10)
			cm.teachSkill(13000003,20,20)
			cm.teachSkill(13000004,20,20)
			// Wind breaker 2nd skill
			...
			// Flame wizard 3rd skill
			cm.teachSkill(12111000,20,20);
			cm.teachSkill(12111001,20,20);
			...
			cm.teachSkill(15000001,20,20);
			cm.teachSkill(15000002,20,20);
			cm.teachSkill(15000003,10,10);
			cm.teachSkill(15000004,20,20);
			// Striker 2nd skill
			cm.teachSkill(15100000,10,10);
			cm.teachSkill(15100001,20,20);
			cm.teachSkill(15100002,20,20);
			cm.teachSkill(15100003,20,20);
			cm.teachSkill(15100004,20,20);
			cm.teachSkill(15100005,20,20);
			cm.teachSkill(15100006,20,20);
			// Striker 3nd skill
			...
			cm.teachSkill(15110000,20,20)
			cm.teachSkill(15110000,20,20)
			// Night walker 1st skill
			cm.teachSkill(14000000,10,10);
			cm.teachSkill(14000001,8,8);
			cm.teachSkill(14000002,10,10);
			cm.teachSkill(14000003,10,10);
			cm.teachSkill(14000004,20,20);
			cm.teachSkill(14000005,20,20);
			// Night walker 2nd skill
			...
			// cm.teachSkill(12110002,20,20);
			// cm.teachSkill(12110003,20,20);
			// cm.teachSkill(12110004,20,20);
			// cm.teachSkill(12110005,30,30);
			// cm.teachSkill(12110006,30,30);
			// // Striker 1st skill
			// cm.teachSkill(15000000,10,10);
			// cm.teachSkill(15000001,20,20);
			// cm.teachSkill(15000002,20,20);
