...
function action(mode, type, selection) {
   ...
   status--;
	...
	text += "哈哈，我就是本服的觉醒商人芸萍，我有迷人的觉醒方法可以帮助你把#v1142007##r★暗黑龙王杀手勋章★#k完成一次#b高级觉醒（全属性50，攻击力50，魔力80）#k\r\n需要以下物品：（确定时请在装备栏和其他栏空出一格，已经完成过高级觉醒的装备无效！）\r\n#v1142007# * 1个\r\n#v4000042##d#z4000042# * 200个\r\n#v4000035##d#z4000035# * 200个\r\n#v4000204##d#z4000204# * 200个\r\n#v4000313##d#z4000313# * 300张\r\n#v4032226##d#z4032226# * 300只\r\n#v2140002##d金币 * 2000W\r\n#v4032186##d#z4032186# * 1个~\r\n"
	text += "\r\n#L1##b我收集了以上物品。确定开始觉醒装备";
	text += "     \r\n"
        cm.sendSimple(text);
        } else if (selection == 1) {
                      if(cm.haveItem(4000313, 300) && cm.haveItem(4000042,200) && cm.haveItem(4000035,200) && cm.haveItem(4000204,200)  && cm.haveItem(4032226,300) && cm.haveItem(1142007,1) && cm.haveItem(4032186,1) && cm.canHold(1142007,1) && cm.canHold(4032187,1)){
                ...
                cm.gainItem(4032187,1)
                                cm.gainItem(1142007,50,50,50,50,0,0,50,80,0,0,0,0,0,0);
            cm.sendOk("觉醒成功！");
            cm.dispose();
