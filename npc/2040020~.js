...
function action(mode, type, selection) {
	...
	var options = new Array("什么是催化剂?","做一双战士手套","做一双弓箭手手套","做一双魔法师手套","做一双飞侠手套",
	    "做一双战士手套使用催化剂","做一双弓箭手手套使用催化剂","做一双魔法师手套使用催化剂","做一双飞侠手套使用催化剂");
	...
	if (selectedType == 0) { //What's a stim?
	    ...
	    var selStr = "很好，那么你想做哪一个？？#b";
	    var items = new Array ("#t1082051##k - 魔法师 等级. 30#b","#t1082054##k - 魔法师 等级. 35#b","#t1082062##k - 魔法师 等级. 40#b","#t1082081##k - 魔法师 等级. 50#b");
	    for (var i = 0; i < items.length; i++){
		selStr += "\r\n#L" + i + "# " + items[i] + "#l";
	    }
	    cm.sendSimple(selStr);
	    ...
	    var selStr = "很好，那么你想做哪一个？？#b";
	    var items = new Array ("#t1082052##k - 魔法师 等级. 30#b","#t1082053##k - 魔法师 等级. 30#b","#t1082055##k - 魔法师 等级. 35#b","#t1082056##k - 魔法师 等级. 35#b",
	    "#t1082063##k - 魔法师 等级. 40#b","#t1082064##k - 魔法师 等级. 40#b","#t1082082##k - 魔法师 等级. 50#b","#t1082080##k - 魔法师 等级. 50#b");
	    for (var i = 0; i < items.length; i++){
		selStr += "\r\n#L" + i + "# " + items[i] + "#l";
	    }
	    cm.sendSimple(selStr);
