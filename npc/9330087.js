...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			cm.1sendSimple("\t\t\t\t\t#e#r流浪商人#b系列#n\r\n#d====================================================\r\n#d目前账户剩余金币:"+ cm.getMeso() + "\r\n====================================================\r\n#k您好，欢迎来到#b百草堂#k，我是全属性装备兑换商人查尔斯\r\n#k#r#e所有好的勋章都在我这哦！#n\r\n\r\n#L1##r#e询问更多关于流浪商人的信息#b#n\r\n\r\n#L2#诚实的冒险家勋章（全属性10==200万）#b#n\r\n\r\n#L3#任务狂人勋章（全属性30==600万）#b#n\r\n\r\n#L4#超人气王勋章（全属性50==1000万）#b#n\r\n\r\n#L5#冒险岛偶像明星勋章（全属性100==#r200张#k#v4000313#）#b#n\r\n\r\n#L6#传说中的冒险家勋章（全属性200==#r388张#k#v4000313#）#b#n\r\n\r\n#L7#暗黑龙王杀手勋章（全属性350==#r588张#k#v4000313#）#b#n\r\n\r\n#L8#英雄战神勋章（全属性500==#r888张#k#v4000313#）");			               
 } else if (status == 1) {
                  if (selection == 1) {
		  cm.sendOk("\t\t\t        #e#b流浪商人系列#n#d\r\n====================================================#k\r\n本服务器开放极品装备兑换交易，任何玩家通过自身努力均可获得#r全属性极品装备#k！#d\r\n====================================================#k\r\n废话不多说，下一个流浪商人在海盗的码头，是个妹子！#d\r\n====================================================#k\r\n怀旧单机讨论群：542123915玩家发现BUG请及时反馈给我们，共同维护一个良好的游戏环境！#k#d\r\n====================================================#k\r\n顺便泄露下下天机，还有很多流浪商人出售各种好东东，记得多旅游才能发现他们哦！#d\r\n");
	          cm.dispose();
                ...
                cm.gainItem(1142000,10,10,10,10,10,10,2,2,10,10,5,5,10,10);
                cm.gainMeso(-2000000);
                ...
                cm.gainItem(1142001,30,30,30,30,30,30,2,2,15,15,5,5,10,10);
                ...
                cm.gainItem(1142003,50,50,50,50,50,50,2,2,20,20,5,5,10,10);
                ...
                cm.gainItem(1142006,100,100,100,100,100,100,5,5,30,30,5,5,15,15);
                ...
                cm.gainItem(1142005,200,200,200,200,200,200,5,5,40,40,5,5,20,20);
                ...
                cm.gainItem(1142007,350,350,350,350,350,350,10,10,55,55,5,5,10,10);
                ...
                cm.gainItem(1142133,500,500,500,500,500,500,15,15,88,88,5,5,5,5);
