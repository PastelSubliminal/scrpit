    ...
    if (mode == -1) {
        ...
        if (status == 0) {
		   ...
		   text += " \t\t\t  #e#d欢迎来到#r怀旧冒险岛#k#n              \r\n          \r\n"
            ...
            text += "#d点券余额：#b" + cm.getPlayer().getCSPoints(1) + "#k#n\t#d   抵用余额：#b" + cm.getPlayer().getCSPoints(2) + "#k#n\r\n"		
...
text += ""+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+爱心+"\r\n\r\n"
 if (cm.getPlayer().isGM()) {
         ...
         //   text += "#L10##b" + 红色箭头 + "免费点装#l#l#L18##b" + 红色箭头 + "排行榜单#l#l#L12##b" + 红色箭头 + "豆豆兑换#l\r\n\r\n"//3
          //  text += "#L13##b" + 红色箭头 + "勋章领取#l#l#L14##b" + 红色箭头 + "本服介绍#l#l#L15##b" + 红色箭头 + "充值介绍#l\r\n\r\n"//3
           // text += "#L17##b" + 红色箭头 + "装备制造#l#l#L19##r" + 蓝色角点 + "限时装备购买#l#l\r\n\r\n"//3
            ...
            //text += "#L8##e#r枫叶换抵用券#l#L9##e#d在线时间奖励#l#L16##e#d删除指定道具#l\r\n\r\n"//3
	...
	} else if (selection == 1999) {//皇家骑宠
             cm.dispose();
            cm.openNpc(9050002);
        } else if (selection == 11999) {//副本系统
             cm.dispose();
            cm.openNpc(9310032);
