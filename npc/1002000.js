...
var townText = [
    ["位于金银岛西南部的港口村庄。连接里恩"],
    ["位于高原的勇士部落，冒险家可以在这里转职成战士。"],
    ["四周都是密密丛丛大树林的法师村。冒险家可以在这里转职成魔法师。"],
    ["位于金银岛南部平原地区的村庄。有弓箭手转职所，可以转职成为弓箭手。"],
    ["以美丽的晚霞而著称的飞侠都市。冒险家可以在这里转职成飞侠。"],
    ["海盗船长凯琳的潜水艇诺特勒斯号停泊的码头。冒险家可以在这里转职成海盗。"],
    ["是个很不错的地方"]
];
var selectedMap = -1;
var town = false;
